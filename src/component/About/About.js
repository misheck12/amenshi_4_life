		...
		<div className='intro'>
          ...
          <div className='px-6 py-12 md:px-12'>
            <p className="uppercase text-2xl text-green-600 font-bold mb-6 flex items-center">
             7 years of experience in Drilling and Maintenance of Water Wells
            </p>
...
<div class="container my-24 px-6 mx-auto">
  ...
  <section class="mb-32 text-gray-800 text-center">
    <h2 class="text-3xl font-bold mb-12">Meet the <u class="text-green-600">Us team</u></h2>
      ...
      <div class="">
        <div class="bg-white block rounded-lg shadow-lg">
          ...
          <div class="p-6">
            ...
            <p class="text-gray-500 mb-4">Founder & Director</p>
            <ul class="list-inside flex mx-auto justify-center">
              <a href="#!" class="px-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4 text-blue-600">
                  <path fill="currentColor"
